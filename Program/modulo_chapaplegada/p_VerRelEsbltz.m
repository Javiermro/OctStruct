function [Verificaciones] = p_VerRelEsbltz(Datos)
%
...
switch PerfilTipo
    ...
    case 'U'
        ...
        Verificaciones.V_RelEsbALA = true*(b/t < 60)+false*(c/t > 60);
        % Esb_Alm: Caso (2) g 18. Elem.Comp. Rigid.
        Verificaciones.V_RelEsbALMA = true*(a/t < CoefEsbAlma)+false*(a/t > CoefEsbAlma);
        % No se usa.
        Verificaciones.V_RelEsbLABIO = true;
end
...
if ~any([Verificaciones.V_RelEsbALMA, Verificaciones.V_RelEsbALA, Verificaciones.V_RelEsbLABIO])
    fprintf('Incumplimiento de una o más relaciones de esbeltez')
    if ~Verificaciones.V_RelEsbALMA
        fprintf(['Esbeltez ALMA: a/t =' num2str(a) '/' num2str(t) '=' num2str(a/t) '>' num2str(CoefEsbAlma)])
    elseif ~Verificaciones.V_RelEsbALA
        fprintf(['Esbeltez ALA: b/t =' num2str(b) '/' num2str(t) '=' num2str(b/t) '> 60'])
    elseif ~Verificaciones.V_RelEsbLABIO
        fprintf(['Esbeltez LABIO: c/t =' num2str(c) '/' num2str(t) '=' num2str(c/t) '> 60'])
    end
